...
button2.addEventListener("click", function() {
    ...
    // Đợi một khoảng thời gian rồi chuyển trang
    setTimeout(() => {
        button2.style.transform = "scale(1)";
        window.location.href = "./index/index.html"; // Chuyển hướng đến trang index
    }, 200);
});
...
function progressInterva(){
    if(count == 100 && percentWidth == 100){
        ...
        percent.textContent = "Okelaa gòiii";
        ...
        setTimeout(()=>{
            textBtn.textContent = "Nhấn dô iii"
